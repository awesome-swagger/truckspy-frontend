...
export const MAPBOX_ACCESS_TOKEN: string = "pk.eyJ1Ijoia2Zob2xicm9vayIsImEiOiJjanVkMzd4dTMwdXRpM3lvZ2Y4YTd6NjkwIn0.ys5sGeUMUzlK0g09vaJG_w";

export const MESSAGES_PAGESIZE: number = 25;

export const mapConfig: any = {
  SATELLITE: "mapbox://styles/kfholbrook/cjv2n4g6728tz1fpar2ragh42",
  STREETS: "mapbox://styles/kfholbrook/cjv2mzt6963gx1fpcfbpyk7l2"
}
...
export const config: any = {
  ...
  voice_commands: {
    ...
    'show billing': {
      type: 'navigate', payload: ['/admin/billing']
    },
